...
<h3>ENTER YOUR NAME: Sanjeev A</h3>
<h3>ENTER YOUR REGISTER NO: 212224230246</h3>
<h3>EX. NO: 02</h3>
...
// Initialize host data with random integer values (0 to 255)
...
// Host matrix addition for comparison
...
// 2D CUDA Kernel for integer matrix addition
...
## OUTPUT:
<img width="845" height="200" alt="image" src="https://github.com/user-attachments/assets/035c9aea-f46c-4351-a0aa-e55a20947817" />

<img width="817" height="205" alt="image" src="https://github.com/user-attachments/assets/08c10c87-b3b3-42b0-a5e7-fcb34170008b" />



## RESULT:
The host took 0.839552 seconds for integer and 0.844228 seconds for float to complete its computation, while the GPU outperforms the host and completes the integer computation in 0.013648 seconds and float computation in 0.025715 seconds. Therefore, integer variables in the GPU will result in the best possible result, running ~1.88x faster than float. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
